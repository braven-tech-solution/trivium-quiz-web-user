  ...
  return (
    <div className="relative ">
      <div className="flex items-center justify-between">
        <h1 className="text-xl     mx-auto uppercase mb-5 text-[#0866FF] font-bold">
          Product Category
        </h1>
        <ActionButton
        ...
        >
          {categories?.map((item, idx) => (
            <TableRow key={idx + 1}>
              ...
              {/* <TableCol styles="min-w-[80px]">{item?.createdBy?.name}</TableCol> */}
              {/* <TableCol styles="min-w-[80px]">{item?.updatedBy?.name}</TableCol> */}
      ...
      {showModal1 && (
        <CommonModal
          containerStyles="w-[90%] md:w-[60%] bg-white"
