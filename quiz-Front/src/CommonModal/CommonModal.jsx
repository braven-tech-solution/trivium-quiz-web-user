...
const CommonModal = ({ children, setShow, containerStyles }) => {
  return (
    <div className="fixed top-0 left-0 w-full h-[110vh] flex items-center justify-center bg-[#382850] bg-opacity-50 ">
      <div
      ...
      >
        ...
        >
          <AiOutlineCloseCircle size={30} className="hover:scale-95 pointer" />
        </div>
        {children}
      </div>
    </div>
